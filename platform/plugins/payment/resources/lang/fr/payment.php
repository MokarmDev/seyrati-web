...
return [
    ...
    'payment_created' => 'Vous avez créé un paiement #:charge_id via :channel :time : :amount',
    ...
    'currency_not_supported' => ':name ne prend pas en charge :currency. Liste des devises prises en charge par :name : :currencies.',
    'please_switch_currency' => 'Veuillez passer à une devise prise en charge',
