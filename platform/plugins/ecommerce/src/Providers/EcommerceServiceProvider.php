...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(FacebookPixel::class);
                ...
                // تسجيل WhatsApp Service كـ Singleton
        $this->app->singleton(\Botble\Ecommerce\Services\WhatsAppService::class, function ($app) {
            return new \Botble\Ecommerce\Services\WhatsAppService();
        });

        // تسجيل PasswordResetService مع WhatsAppService
        $this->app->singleton(\Botble\Ecommerce\Services\PasswordResetService::class, function ($app) {
            return new \Botble\Ecommerce\Services\PasswordResetService(
                $app->make(\Botble\Ecommerce\Services\WhatsAppService::class)
            );
        });
