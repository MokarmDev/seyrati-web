                ...
                <div class="table-responsive">
                    <x-core::table class="table-striped">
                        <x-core::table.header>
                            ...
                            <x-core::table.header.cell class="d-none d-md-table-cell">{{ trans('core/base::tables.date') }}</x-core::table.header.cell>
                            <x-core::table.header.cell class="d-none d-md-table-cell">{{ trans('plugins/ecommerce::order.customer') }}</x-core::table.header.cell>
